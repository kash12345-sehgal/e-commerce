...
<hr className='border-none h-[1.5px] w-8 bg-gray-800'/>
      ...
      {currentSate=== 'Login'? '':<input  onChange={(e) => setName(e.target.value)}value={name} type="text" className='w-full px-3 py-2 border border-gray-800' placeholder='Name'required/>}
      ...
      <div className='w-full flex justify-between text-sm mt-[-8px]'>
        ...
        {
          currentSate==='Login'
          ? <p onClick={()=>setCurrentState('Sign Up')} className='cursor-pointer text-blue-600'>Create an account</p>
